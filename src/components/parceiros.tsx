...
export function AnimatedBeamDemo() {
    ...
    return (
        <div
            className="relative flex h-[400px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background mt-2 p-5 md:shadow-xl"
            ref={containerRef}
        >
...
const Icons = {
    ...
    ufpe: () => (
        <Image alt="ufpe logo" src={"/ufpe.png"} width={100} height={100}></Image>
    ),
    notion: () => (
        <svg
            width="100"
